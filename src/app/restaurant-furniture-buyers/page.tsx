        ...
        <div className="container grid items-center gap-4 lg:gap-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)]">
          <div className="min-w-0">
            ...
            <h1 className="mt-5 text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.05] text-[#070f22] animate-fade-up animate-fade-up-1">
              Restaurant & Hotel
              <br />
              Furniture Buyers in {SITE.city}
            </h1>

            <p className="mt-5 text-base md:text-lg text-[#475569] max-w-xl animate-fade-up animate-fade-up-2">
              We buy restaurant chairs, tables, booths, kitchen equipment, ACs, and complete shut-down lots. Door pickup and instant cash payment.
            </p>
            ...
            <div className="mt-7 flex flex-wrap gap-3 animate-fade-up animate-fade-up-4">
              ...
              <a
                href={whatsappLink("Hi, I want to sell restaurant / hotel furniture.")}
          ...
          <div className="relative w-full max-w-2xl mx-auto">
            <div className="relative aspect-[5/4] rounded-3xl overflow-hidden bg-[#faedc8] shadow-xl">
              <Image
                src="/images/restaurant-hero.avif"
                alt="Restaurant furniture buyers in Hyderabad"
                fill
                priority
                unoptimized
              ...
              />
              <div className="absolute top-4 left-4 md:top-5 md:left-5 max-w-[55%] z-10">
                <p className="font-serif italic text-[#0f1c36] text-lg md:text-xl lg:text-2xl leading-[1.05] drop-shadow-sm">
                  We buy it,
                  <br />
                  You get paid!
                </p>
                <svg
                  className="mt-1 h-2.5 w-28 md:w-36 text-[#0f1c36]"
                  viewBox="0 0 200 12"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="3"
